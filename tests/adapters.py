...
from ece496b_basics.Transformer import *
from ece496b_basics.loss import *
from ece496b_basics.AdamWOptimizer import *
from ece496b_basics.trainer import *
...
def run_multihead_self_attention(
    ...
    """
    MHA = CausalMultiheadSelfAttention(d_model, num_heads, attn_pdrop)
    MHA.load_weights_from_dict(weights)
...
def run_transformer_block(
    ...
    block.load_weights_from_dict(weights)
...
def run_transformer_lm(
    ...
    lm.load_weights_from_dict(weights)
